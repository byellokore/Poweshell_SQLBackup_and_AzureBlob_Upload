#Powershell Script to Backup and Upload SQL Server Database to Azure Blob. At the end you can also find a slack example to send a message to a #channel when the backup is finished.
